...
export default function EditEntry({ entry }: EditEntryProps) {

    const {data, setData, post, processing, errors} = useForm({
        title: entry.title,
        body: entry.body,
        hours_coded: entry.hours_coded.toString(),
        tags: entry.tags || "",
    });
    ...
    <div className="w-full max-w-2xl">
        <h1 className="text-3xl font-bold mb-6 text-gray-800">Edit Entry</h1>
